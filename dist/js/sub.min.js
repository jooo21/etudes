$(document).ready((function(){var t=$("#panel").find("td>p"),n=$(".community .tab").find(".btn li");$(window).on("resize load",(function(){if($(window).width()<1179){var n=t.text().substr(0,30)+"...";t.text(n)}if($(window).width()<539){n=t.text().substr(0,15)+"...";t.text(n)}})),n.on("click",(function(t){t.preventDefault(),n.find("a").removeClass("on"),$(this).find("a").addClass("on")}))}));
...
$(document).ready((function(){var o=$(".intro .sub").offset().top;$(window).on("scroll",(function(){var s=$(this).scrollTop();if(s>=o+-1300){var t=2820-(s=4*(s-(o+-1300)));t<0&&(t=0);var n=s/6e3;n>.3&&(n=.3),$(".sub li").find("path").css({strokeDashoffset:t})}}))}));
$(document).ready((function(){var n=$(".faq dl dt"),d=$(".faq dl dd"),e=n.find("a");e.on("click",(function(n){n.preventDefault(),function(n){var a=n.hasClass("on");if(e.removeClass("on"),d.slideUp(),a)return n.removeClass("on"),void n.parent().next("dd").slideUp();n.addClass("on"),n.parent().next("dd").slideDown()}($(this))}))}));
$(document).ready((function(){var t="795ec68eff11550e1c52deed3a86011b";function e(t,e,i,s){$.ajax({url:t,dataType:"json",data:{api_key:e,per_page:i,format:"json",nojsoncallback:1,tags:s,tagmode:"any",privacy_filter:5}}).success((function(t){var e=t.photos.photo;$("#gallery ul").empty(),$(e).each((function(t,e){$("#gallery ul").append($("<li>").append($("<div class='boxAni'>").append($("<div class='top'>"),$("<div class='right'>"),$("<div class='bottom'>"),$("<div class='left'>")),$("<div class='textbox1'>").append($("<p>").text(this.title),$("<span>"),$("<em>").text(this.owner),$("<em>").text("Kor")),$("<a>").attr({href:"https://farm"+this.farm+".staticflickr.com/"+this.server+"/"+this.id+"_"+this.secret+"_b.jpg"}).append($("<img>").attr({src:"https://farm"+this.farm+".staticflickr.com/"+this.server+"/"+this.id+"_"+this.secret+"_m.jpg",onerror:"javascript:this.parentNode.parentNode.style='display:none;'"}),$("<div>").append($("<div>").append($("<img>").attr({src:"http://farm"+this.farm+".staticflickr.com/"+this.server+"/buddyicons/"+this.owner+".jpg",onerror:"javascript:this.src = '../img/b2.jpg'"}).css({borderRadius:"50%"}))),$("<p>").text(this.title).css({display:"none"})),$("<div class='textbox2'>").append($("<span>").text("©2020.all rights reserved"))))}))})).error((function(t){console.error(t)}))}e("https://www.flickr.com/services/rest/?method=flickr.interestingness.getList",t,21),$("body").on("click","#gallery ul li a",(function(t){t.preventDefault(),function(t,e){$("body").append($("<aside class='pop'>").append($("<img>").attr("src",t),$("<p>").text(e),$("<span>").text("close"))),$(".pop").fadeIn()}($(this).attr("href"),$(this).find("p").text())})),$("body").on("click",".pop span",(function(){$(this).parent().fadeOut(500,(function(){$(this).remove()}))})),$("#search button").on("click",(function(){var i=$(this).prev().val();e("https://www.flickr.com/services/rest/?method=flickr.photos.search",t,50,i)})),$("body").on("mouseenter","#gallery ul li",(function(){!function(t){t.fadeIn(100,(function(){t.find(".top").animate({width:"100%"},250,"easeOutExpo"),t.find(".bottom").animate({width:"100%"},250,"easeOutExpo")}))}($(this).find(".boxAni"))})),$("body").on("mouseleave","#gallery ul li",(function(){var t=$("#gallery ul li").find(".boxAni");t.fadeOut(500,(function(){$(this).find(".top").css({width:"0%"}),$(this).find(".bottom").css({width:"0%"})}))}))}));
$(document).ready((function(){var o=$("#header_sub"),e=$("#gnb>li"),n=e.children(".sub");e.on("mouseenter focusin",(function(){!function(e){var t=$(e).children(".sub").outerHeight(),i=n.css("background-color"),s=o.outerHeight(),d=$(".bgGnb").length;"MEMBERS"==$(e).find("a").eq(0).text()&&$(e).find("video").get(0).play();d||o.prepend($("<div class='bgGnb'>").css({width:"100%",height:t,backgroundColor:i,position:"absolute",left:0,top:s,display:"none",overflow:"hidden",borderBottom:"1px solid #e9e4dc"}));$(e).children(".sub").stop().show(),$(".bgGnb").stop().show()}(this)})),e.on("mouseleave focusout",(function(){!function(o){"MEMBERS"===$(o).find("a").eq(0).text()&&$(o).find("video").get(0).pause();$(o).children(".sub").stop().hide(),$(".bgGnb").hide()}(this)}));var t=$(".moGnbBtn"),i=$(".moGnb");t.on("click",(function(o){o.preventDefault(),$(this).toggleClass("on"),i.toggleClass("on")}))}));
window.onload=function(){var e=document.querySelector(".showBox"),a=document.querySelectorAll(".branch li"),t=document.querySelectorAll(".traffic li")[0],n=document.querySelectorAll(".traffic li")[1],o=new kakao.maps.LatLng(37.56720412888648,127.00998345887412);window.addEventListener("resize",(function(){var e=document.querySelector(".branch li.on"),a=parseInt(e.getAttribute("data-index"))-1;i.setCenter(s[a].latlng)}));o={center:new kakao.maps.LatLng(37.56720412888648,127.00998345887412),level:4};var s=[{title:"본점",latlng:new daum.maps.LatLng(37.56720412888648,127.00998345887412),imgSrc:"img/map.png",imgSize:new daum.maps.Size(64,64),imgPos:{offset:new kakao.maps.Point(44,32)},button:a[0]},{title:"지점",latlng:new daum.maps.LatLng(37.566373563053446,126.97788269620722),imgSrc:"img/map.png",imgSize:new daum.maps.Size(64,64),imgPos:{offset:new kakao.maps.Point(44,32)},button:a[1]},{title:"지점2",latlng:new daum.maps.LatLng(37.54440330709019,127.03765853629974),imgSrc:"img/map.png",imgSize:new daum.maps.Size(64,64),imgPos:{offset:new kakao.maps.Point(44,32)},button:a[2]}],i=new kakao.maps.Map(e,o),l=new daum.maps.MapTypeControl;i.addControl(l,daum.maps.ControlPosition.TOPRIGHT);var r,m,d=new daum.maps.ZoomControl;i.addControl(d,daum.maps.ControlPosition.BOTTOMRIGHT),t.addEventListener("click",(function(e){e.preventDefault(),i.removeOverlayMapTypeId(daum.maps.MapTypeId.TRAFFIC),i.addOverlayMapTypeId(daum.maps.MapTypeId.TRAFFIC),t.classList.add("on"),n.classList.remove("on")})),n.addEventListener("click",(function(e){e.preventDefault(),i.removeOverlayMapTypeId(daum.maps.MapTypeId.TRAFFIC),n.classList.add("on"),t.classList.remove("on")}));for(var c=0;c<s.length;c++)new daum.maps.Marker({map:i,position:s[c].latlng,title:s[c].title,image:new daum.maps.MarkerImage(s[c].imgSrc,s[c].imgSize,s[c].imgPos)}),function(e){s[e].button.addEventListener("click",(function(a){a.preventDefault();for(var t=0;t<s.length;t++)s[t].button.classList.remove("on"),document.querySelectorAll(".branchAdd li")[t].classList.remove("on"),document.querySelectorAll(".info li")[t].classList.remove("on");s[e].button.classList.add("on"),document.querySelectorAll(".branchAdd li")[e].classList.add("on"),document.querySelectorAll(".info li")[e].classList.add("on"),u(s[e].latlng)}))}(c);function u(e){var a=e;return i.setCenter(a),!1}r=!0,i.setDraggable(r),m=!1,i.setZoomable(m);var p=$("#map"),g=p.find(".showBox"),f=p.find(".traffic");p.on("mouseenter",(function(){g.css({filter:"contrast(100%) grayscale(0)"}),f.css({filter:"contrast(100%) sepia(0%)"})})),p.on("mouseleave",(function(){g.css({filter:"contrast(50%)"}),f.css({filter:"contrast(70%) sepia(5%)"})}))};
$(document).ready((function(){var n,e=$("#loBanner"),i=e.find(".list"),t=i.children("li").width(),r=e.find(".prev"),a=e.find(".next"),c=-t,l=!0,f=i.children("li").length,o=t*f;function s(){c<=2*-t?(c=-t,i.children("li").first().appendTo(i)):c--,i.css({marginLeft:c})}i.css({width:o,marginLeft:-t}),n=setInterval(s,20),e.on("mouseenter",(function(){clearInterval(n)})),e.on("mouseleave",(function(){n=setInterval(s,20)})),a.on("click",(function(n){n.preventDefault(),l&&(l=!1,i.animate({marginLeft:2*-t},500,(function(){i.children("li").first().appendTo(i),i.css({marginLeft:-t}),c=-t,l=!0})))})),r.on("click",(function(n){n.preventDefault(),l&&(l=!1,i.animate({marginLeft:0},500,(function(){i.children("li").last().prependTo(i),i.css({marginLeft:-t}),c=-t,l=!0})))}))}));
$(document).ready((function(){function e(e,r){null==r&&(r=5);var a=$($("[name = '"+e+"']"))[0];console.log(a);var n=$(a).is("textarea");console.log(n);var t=$("[name='"+e+"']").val();$("[name='"+e+"']").attr("placeholder");return""==t?($("[name='"+e+"']").addClass("error"),$(".alert").addClass("error"),!1):t.length<r?(alert("최소 "+r+"글자 이상 입력하세요"),$("[name='"+e+"']").addClass("error"),$(".alert").addClass("error"),!1):($("[name='"+e+"']").removeClass("error"),$(".alert").removeClass("error"),!0)}function r(e){var r=$("input[name='"+e+"']").is(":checked");$("input[name='"+e+"']").parent().siblings(".alert").text();return r?($("input[name='"+e+"']").parent().siblings(".alert").removeClass("error"),!0):($("input[name='"+e+"']").parent().siblings(".alert").addClass("error"),!1)}function a(e){var r=$("select[name='"+e+"']").children("option:selected").val();$("select[name='"+e+"']").children("option").eq(0).text();return""==r?($("select[name='"+e+"']").addClass("error"),!1):($("select[name='"+e+"']").removeClass("error"),!0)}$("input[type=submit]").on("click",(function(n){r("check")||n.preventDefault(),e("id")&&a("id")||n.preventDefault(),function(e,r,a){null==a&&(a=5);var n=$("input[name='"+e+"']").val(),t=$("input[name='"+r+"']").val(),l=0;n===t?(n.length>=a?l++:alert("비밀번호는 "+a+"자리 이상 입력하세요"),4!=l?($("input[name='"+e+"']").addClass("error"),$("input[name='"+r+"']").addClass("error")):($("input[name='"+e+"']").removeClass("error"),$("input[name='"+r+"']").removeClass("error"))):($("input[name='"+e+"']").addClass("error"),$("input[name='"+r+"']").addClass("error"))}("pwd1","pwd2")||n.preventDefault(),e("name")||n.preventDefault(),e("birth")||n.preventDefault(),a("gender")||n.preventDefault(),e("phone")||n.preventDefault(),a("marriage")||n.preventDefault(),e("anniver")||n.preventDefault(),r("route")||n.preventDefault()})),$("select[name=id]").on("change",(function(){var e=$(this).val();$(".idMail").text(e)}))}));
$(document).ready((function(){!function(e){var t,n={name:"#popup",data_url:"pop/pop.html",isMask:!1,isCk:!1,custom_css:void 0};(e=Object.assign({},n,e)).isMask&&$("body").append($("<div class='mask'>").css({width:"100%",height:"100%",backgroundColor:"rgba(0,0,0,0.2)",position:"fixed",top:0,left:0,zIndex:11,display:"none"}).fadeIn());var o={position:"absolute",top:"50%",left:"50%",transform:"translate(-50%,-50%)",zIndex:12,display:"none"};t=null==e.custom_css?o:Object.assign({},o,e.custom_css);var s=e.name.split("#")[1];$("body").append($("<aside>").attr("id",s).css(t).append($("<div class='content'>"),$("<div class='wrap'>").append($("<input type='checkbox' id='ck'>").css({cursor:"pointer",marginRight:10}),$("<label for='ck'>").text("오늘 하루 보지 않기").css({cursor:"pointer"})),$("<a href='#'>").addClass("close").text("닫기")).fadeIn()),e.isCk||$(e.name).find(".wrap").hide();$.ajax({url:e.data_url,success:function(t){$(e.name).find(".content").html(t)},error:function(){console.error()}})}({name:"#popup",data_url:"pop.html",isMask:!0,isCk:!0}),-1==document.cookie.indexOf("popup=done")?($("#popup").show(),$(".mask").show()):($("#popup").hide(),$(".mask").hide()),$("body").on("click","#popup .close",(function(e){e.preventDefault(),function(e){var t=$(e).prev().find("input[type=checkbox]").is(":checked"),n=$(e).parent().attr("id");t&&function(e,t,n){var o=new Date,s=o.getDate();o.setDate(s+n);var a=o.toGMTString();document.cookie=e+"="+t+"; path=/; expires="+a}(n,"done",1);$(e).parent().fadeOut(500,(function(){$(this).remove()})),$(".mask").fadeOut(500,(function(){$(this).remove()}))}(this)}))}));
...
$(document).ready((function(){var e;function t(e){$("body").append($("<aside class='youtube_pop'>").css({width:e.width,height:e.height,backgroundColor:e.bg,position:"fixed",top:"50%",left:"50%",transform:"translate(-50%, -50%)",boxSizing:"border-box"}).append($("<a href='#' class='close'>").text("close"),$("<img src='img/loading2.gif'>").css({width:100,position:"absolute",top:"50%",left:"50%",transform:"translate(-50%,-50%)"}),$("<div class='con'>").css({width:"100%",height:"100%",position:"relative",display:"none"}).append($("<iframe>").attr({src:"https://www.youtube.com/embed/"+e.vidId,width:"100%",height:"100%",frameborder:0,allowfullscreen:!0})))),setTimeout((function(){$(".youtube_pop .con").fadeIn(500,(function(){$(this).prev().remove()}))}),1e3)}e={target:".swiper-wrapper",count:5,key:"AIzaSyBwZO8IOadpZ-xSxAGeED_qdvcR150TQCA ",playList:"PLaZXpj41N2i0MV87FZVYsnxRttVCdOOlI"},$.ajax({url:"https://www.googleapis.com/youtube/v3/playlistItems",dataType:"jsonp",data:{part:"snippet",key:e.key,maxResults:e.count,playlistId:e.playList}}).success((function(t){var i=t.items;$(i).each((function(t,i){var s=i.snippet.description,o=s.length;i.snippet.publishedAt.split("T")[0],o>100&&(s=s.substr(0,45)+"..."),$(e.target).append($("<div class='swiper-slide'>").append($("<idv class='inner'>").append($("<a class='pic'>").attr({href:i.snippet.resourceId.videoId}).css({backgroundImage:"url("+i.snippet.thumbnails.high.url+")"}),$("<div class='con'>").append($("<h2>").text(i.snippet.title),$("<p>").text(s).append($("<a class='pic_href'>").attr({href:i.snippet.resourceId.videoId}).text("VIEW MORE"))))))})),new Swiper("#wrap",{direction:"horizontal",loop:!0,spaceBetween:0,grabCursor:!0,slidesPerView:"auto",centeredSlides:!0,speed:1e3,mousewheel:!1,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},autoplay:{delay:3e3,disableOnInteraction:!1},effect:"coverflow",coverflowEffect:{rotate:0,stretch:-150,depth:0,modifier:1,slideShadows:!1}})})).error((function(e){console.error(e)})),function(e){$.ajax({url:"https://www.googleapis.com/youtube/v3/playlistItems",dataType:"jsonp",data:{part:"snippet",key:e.key,maxResults:e.count,playlistId:e.playList}}).success((function(t){var i=t.items;$(i).each((function(t,i){var s=i.snippet.description,o=s.length;i.snippet.publishedAt.split("T")[0];o>50&&(s=s.substr(0,50)+"..."),$(e.target).append($("<li>").append($("<div class='pic'>").css({backgroundImage:"url("+i.snippet.thumbnails.high.url+")"}).append($("<a class='pic_href'>").attr({href:i.snippet.resourceId.videoId}).text("click"),$("<div class='con'>").append($("<h2>").text(i.snippet.title)))))}))})).error((function(e){console.error(e)}))}({target:".youtube2",count:4,key:"AIzaSyBwZO8IOadpZ-xSxAGeED_qdvcR150TQCA ",playList:"PLaZXpj41N2i3pMtiMrPFqcDYIia5AhcaT"}),$("body").on("click",".swiper-slide .pic_href",(function(e){e.preventDefault(),t({width:"100%",height:"100vh",bg:"rgba(0,0,0,0.9)",vidId:$(this).attr("href")}),$("body").css({overflow:"hidden"})})),$("body").on("click",".youtube2 .pic_href",(function(e){e.preventDefault(),t({width:"100%",height:"100vh",bg:"rgba(0,0,0,0.9)",vidId:$(this).attr("href")}),$("body").css({overflow:"hidden"})})),$("body").on("click",".youtube_pop .close",(function(e){e.preventDefault(),$(this).parent().remove(),$("body").css({overflow:"auto"})}))}));